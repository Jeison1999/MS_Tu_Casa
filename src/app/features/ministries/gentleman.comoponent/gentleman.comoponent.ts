...
export class GentlemanComoponent implements OnInit, OnDestroy {
  ...
  leader = {
    name: 'Jeison Ortiz Salinas',
    role: 'Líder Escuadrón de fe',
    photo: '',
    age: 0,
    yearsLeading: 0,
  ...
  verses = [
    ...
    },
    {
      ...
      text: 'Oh hombre, él te ha declarado lo que es bueno: hacer justicia, amar misericordia, y humillarte ante tu Dios.',
    },
  ];

  events = [
    {
      title: 'Reunión Escuadrón de fe',
      description: 'Palabra, comunión y fortaleza entre hombres de Dios.',
      day: 'Por confirmar',
      time: '—',
      tag: 'Reunión',
    },
    {
      title: 'Encuentro de caballeros',
      description: 'Tiempo de edificación y servicio mutuo en Cristo.',
      day: 'Próximamente',
      time: 'Fecha especial',
      tag: 'Evento',
    },
    {
      title: 'Desayuno / retiro',
      description: 'Espacio para buscar más de Dios y caminar juntos.',
      day: 'Mensual',
      time: 'Por confirmar',
      tag: 'Comunión',
    },
  ...
  ngOnInit() {
    ...
    this.logo = this.cloudinary.getOptimizedImage('Escuadron_de_fe_bppvmy.png', 700, 92);
